...
<head>
    ...
    <title>IndiaGlobe Cine - Master Overlay Studio v4.2</title>
    ...
    <style>
        ...
        :root {
            ...
            --avatar-bg-color: #16181c; /* New Variable for Profile Background */
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        input[type="text"]:focus, textarea:focus { outline: none; border-color: var(--studio-focus); box-shadow: 0 0 0 2px rgba(59, 130, 246, 0.2); }
        ...
        .avatar-box {
            ...
            background-color: var(--avatar-bg-color); /* Linked to new variable */
        ...
        .badge {
            ...
            fill: var(--post-verified-color); flex-shrink: 0;
        }
        ...
        <div class="panel-scroll-area">
            ...
            <div class="input-group">
                <div class="flex-between">
                    ...
                    <span style="font-size: 10px; color: var(--studio-text-muted);">*bold* supported</span>
                </div>
...
— *India Globe Cine* Investigates The Latest National Exam Security Concerns</textarea>
                    ...
                    <div class="id-box">
                        <div class="name-row">
                            ...
                            <svg class="badge" viewBox="0 0 24 24">
                                <g>
                                    <path d="M22.5 12.5c0-1.58-.875-2.95-2.148-3.6.154-.435.238-.905.238-1.4 0-2.21-1.71-3.998-3.918-3.998-.47 0-.92.084-1.336.25C14.818 2.415 13.51 1.5 12 1.5s-2.816.917-3.337 2.25c-.416-.165-.866-.25-1.336-.25-2.21 0-3.918 1.792-3.918 4 0 .495.084.965.238 1.4-1.273.65-2.148 2.02-2.148 3.6 0 1.46.74 2.746 1.867 3.45-.032.224-.048.452-.048.68 0 2.21 1.71 3.998 3.918 3.998.47 0 .92-.084 1.336-.25C9.184 21.585 10.49 22.5 12 22.5s2.816-.917 3.337-2.25c.416.165.866.25 1.336.25 2.21 0 3.918-1.792 3.918-4 0-.228-.016-.456-.048-.68 1.127-.704 1.867-1.99 1.867-3.45z" fill="currentColor"></path>
    ...
    <aside class="panel right">
        ...
        <div class="panel-scroll-area">
            ...
            <div class="color-picker-wrapper">
                <div class="color-picker-left">
                    <input type="color" id="cp-badge" value="#1d9bf0">
                    <span class="label">Verified Badge Color</span>
                </div>
                <span class="color-hex" id="hex-badge">#1D9BF0</span>
            </div>

            <div class="section-label" style="margin-top: 10px;">Global Structure</div>

            <div class="input-group">
                <div class="flex-between"><label>Total Post Width</label><span class="val-badge" id="val-width">600px</span></div>
                <input type="range" id="sl-width" min="300" max="1000" value="600" step="10">
            </div>

            <div class="input-group">
                <div class="flex-between"><label>Body Text Size</label><span class="val-badge" id="val-text">24px</span></div>
                <input type="range" id="sl-text" min="14" max="40" value="24">
            </div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            DOM.inpAvatar.addEventListener('change', (e) => {
                ...
                if (file) {
                    ...
                    reader.onload = (ev) => DOM.outAvatar.src = ev.target.result;
                    reader.readAsDataURL(file);
                }
            });

            const bindSlider = (node, cssVar, displayId) => {
                node.addEventListener('input', (e) => {
                    document.documentElement.style.setProperty(cssVar, `${e.target.value}px`);
                    document.getElementById(displayId).textContent = `${e.target.value}px`;
                });
            };
            ...
            bindColor(DOM.cpBadge, DOM.hexBadge, '--post-verified-color');

            // Background has special logic for the badge cutout
